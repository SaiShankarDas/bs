...
const itineraryDays = [
  {
    ...
    items: [
      "Depart from Delhi at 9:00 PM for an overnight journey towards the mountains.",
  ...
  {
    day: "Day 1",
    title: "Rajgundha Valley & Barot Arrival",
    items: [
      "En route visit to the breathtaking Rajgundha Valley.",
      "Arrival in Barot Valley and check-in at our riverside camps.",
      "Relax by the serene Uhl River and enjoy the mountain air.",
      "Go for a peaceful forest walk and enjoy leisure time in nature.",
      "Evening bonfire and group activities under the starlit sky."
    ],
    quote: "# Serenity by the river, memories in the valley."
  },
  {
    day: "Day 2",
    title: "Barot Dam & Bir Bound",
    items: [
      "Visit the iconic Barot Dam after breakfast.",
      "Departure towards Bir, the paragliding capital of India.",
      "Visit the peaceful Chokling Monastery.",
      "Optional paragliding at Bir for the ultimate adrenaline rush (additional cost).",
      "Enjoy cafe hopping and explore the vibrant culture of Bir.",
      "Witness a magical sunset at the famous landing site."
    ],
    quote: "# Fly like a bird, live like a nomad."
  },
  {
    day: "Day 3",
    title: "Waterfall & Return Journey",
    items: [
      "Visit the hidden Bangoru Waterfall for a refreshing morning.",
      "Quick cafe stop for lunch and some last-minute exploration.",
      "Departure for Delhi with a heart full of memories.",
      "Overnight journey back home."
    ],
...
const inclusions = [
  "Transportation (Tempo Traveller) from Delhi to Delhi.",
  "Stay - 2 nights (Camps/Guesthouse).",
  "Meals: 3 Breakfast & 3 Dinner.",
  "Guided forest walks and valley visits.",
  "Experienced host by Bharatescapes."
];

const exclusions = [
  "Paragliding charges (Optional).",
  "Insurance.",
...
const BirBarotItineraryPage: React.FC = () => {
  ...
  return (
    <PageTransition>
      ...
      <section className="relative h-[60vh] md:h-[70vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 bg-[url('/images/destinations/bir_barot.png')] bg-cover bg-center" />
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl">
          ...
          >
            A perfect blend of adrenaline, tranquility, and Himalayan culture.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            ...
            <div id="booking-form" className="pt-16 mt-8 border-t border-gray-200 scroll-mt-24">
              <div className="max-w-2xl mx-auto bg-warm-white/50 p-8 rounded-3xl border border-theme-accent-orange-start/20 shadow-lg">
                <div className="mb-8 text-center">
                  <span className="inline-block px-4 py-1.5 bg-accent-gold/20 text-accent-gold font-bold tracking-wider uppercase rounded-full mb-4">Upcoming Batch</span>
                  <h3 className="text-3xl font-playfair font-bold mb-3 text-primary-start">8th - 10th May</h3>
              ...
              <div className="mt-8 text-center">
                <Link to="/himachal" className="inline-flex items-center text-gray-500 hover:text-primary-start font-medium transition-colors">
                  <ArrowRight className="w-4 h-4 mr-180 rotate-180" /> Back to Himachal Escapes
                </Link>
              </div>
            </div>
...
export default BirBarotItineraryPage;
